 ...
 * The clipboard data format used by the adapter is compatible with the clipboard format used by Excel. 
 * This provides for clipboard interoperability between enabled JTables and Excel.
 * 
 * Adapted from:
